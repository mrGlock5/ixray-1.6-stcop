...
public:
	...
	static bool InitTexture(const shared_str& raster_texture_name, const shared_str& svg_texture_name, CUIStaticItem* tc, float fWidgetWidth, float fWidgetHeight);
